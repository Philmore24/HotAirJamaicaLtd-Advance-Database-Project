...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <address>
        <strong>Email:</strong>   <a href="mailto:fosterphilmore@gmail.com ">fosterphilmore@gmail.com </a>
        <br />
    ...
    <address>
        &nbsp;<address>
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="purchasebutton" />
